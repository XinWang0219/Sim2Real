        ...
        for batch in loader:
            ...
            if 1:
                ...
                for i in range(batch_size):
                    ...
                    pred = pred * 255
                    cv2.imwrite("./test/pred_{}_{}.png".format(str(i), index_binimg), pred)

                    # save binimg
                    binimg = binimgs[0][0].cpu().numpy()
                    binimg = binimg * 255
                    cv2.imwrite("./test/binimg_{}_{}.png".format(str(i), index_binimg), binimg)
